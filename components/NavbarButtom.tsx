  ...
  return (
    <div className='max-w-container mx-auto py-2 px-6 flex items-center justify-between'>
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <MdOutlineLocationOn/>
          <p className="text-sm text-zinc-200">Boulevard, 8000</p>
          <FaPlaceOfWorship/>
          <p className="text-sm text-zinc-200">Boulevard Supercenter</p>
        </div>
      ...
      <ul className="flex gap-6 text-sm font-semibold">
        ...
        <li className="bottomNavLi">Grocery and Essentials</li>
        ...
        <li className="bottomNavLi">AA+</li>
      </ul>
    </div>
  );
};
