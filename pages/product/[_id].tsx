    ...
    <div className='w-full bg-white'>
        ...
        <div className='w-1/3 h-full flex flex-col gap-2'>
         ...
         <div className='flex flex-col gap-1'>
            <p className='text-sm text-orange underline underline-offset-4'>
                {product.brand}
            </p>
            ...
            <div className='flex gap-2 items-center text-xs mt-2 text-orange'>
         ...
         <div>
            ...
            <div className='w-full grid grid-cols-3 gap-4 text-xs'>
                <div className='w-full border border-zinc-400 text-orange round-md flex flex-col items-center justify-center p-2'>
            ...
            <p className='font-bold text-xs text-blue'>
                Boulivard,8000{""}
